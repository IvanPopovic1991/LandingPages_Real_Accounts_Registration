...
public class ChromeDriverManager extends DriverManager {
    ...
    public void createWebDriver(String version) {
        System.setProperty("webdriver.chrome.driver","C:\\Users\\ivanp\\Desktop\\Automation projects\\LandingPages_Real" +
                "_Accounts_Registration\\src\\main\\resources\\chromedriver"+version+".exe");
