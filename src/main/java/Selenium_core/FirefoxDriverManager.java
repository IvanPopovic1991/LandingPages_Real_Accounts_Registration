...
public class FirefoxDriverManager extends DriverManager{
    ...
    public void createWebDriver(String version) {
        System.setProperty("webdriver.gecko.driver","C:\\Users\\ivanp\\Desktop\\Automation projects\\LandingPages_Real" +
                "_Accounts_Registration\\src\\main\\resources\\geckodriver"+version+".exe");
